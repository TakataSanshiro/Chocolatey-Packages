...
Install-ChocolateyPackage "$packageName" "$installerType" "$silentArgs" "$url"  -validExitCodes $validExitCodes -Checksum 1EC23A9372F25A06463C8484FE47B87BEF1CFD680421856120B5B70FD99B3531 -ChecksumType sha256
