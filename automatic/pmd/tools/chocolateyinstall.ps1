...
$pmd_home = Join-path $package 'pmd-bin-6.32.0'
$pmd_bin  = Join-Path $pmd_home 'bin/pmd.bat'
$cpd_bin  = Join-Path $pmd_home 'bin/cpd.bat'

$packageArgs = @{
  packageName    = 'pmd'
  url            = 'https://github.com/pmd/pmd/releases/download/pmd_releases%2F6.32.0/pmd-bin-6.32.0.zip'
  checksum       = 'abf7589fc74a3abeb04decb563a92c72116dc553fc88efb23bf68b81924d4569'
  checksumType   = 'sha256'
  softwareName   = 'PMD'
