...
$pmd_home = Join-path $package 'pmd-bin-6.23.0'
$pmd_bin  = Join-Path $pmd_home 'bin/pmd.bat'
$cpd_bin  = Join-Path $pmd_home 'bin/cpd.bat'

$packageArgs = @{
  packageName    = 'pmd'
  url            = 'https://github.com/pmd/pmd/releases/download/pmd_releases%2F6.23.0/pmd-bin-6.23.0.zip'
  checksum       = '03d29d287911083abc15e057f3a45d6164f02e2c12b4d06e7b888ec307ae288c'
  checksumType   = 'sha256'
  softwareName   = 'PMD'
