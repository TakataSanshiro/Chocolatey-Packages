...
$pmd_home = Join-path $package 'pmd-bin-6.41.0'
$pmd_bin  = Join-Path $pmd_home 'bin/pmd.bat'
$cpd_bin  = Join-Path $pmd_home 'bin/cpd.bat'

$packageArgs = @{
  packageName    = 'pmd'
  url            = 'https://github.com/pmd/pmd/releases/download/pmd_releases%2F6.41.0/pmd-bin-6.41.0.zip'
  checksum       = '917c94ba4a8b14875a0693bea229b2af39869ba6cdc2841a44322832d66ae399'
  checksumType   = 'sha256'
  softwareName   = 'PMD'
