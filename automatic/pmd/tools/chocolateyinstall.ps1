...
$pmd_home = Join-path $package 'pmd-bin-6.27.0'
$pmd_bin  = Join-Path $pmd_home 'bin/pmd.bat'
$cpd_bin  = Join-Path $pmd_home 'bin/cpd.bat'

$packageArgs = @{
  packageName    = 'pmd'
  url            = 'https://github.com/pmd/pmd/releases/download/pmd_releases%2F6.27.0/pmd-bin-6.27.0.zip'
  checksum       = '2b9e4186d645433af73cc680b2c8ef99b9fcdc2d224a05161ec9637459cbec0e'
  checksumType   = 'sha256'
  softwareName   = 'PMD'
